    ...
    <main class="container mt-5">
        <section class="row">
            <article class="col-md-12 mt-3">
                ...
                <br><br><h5>Betriebssysteme:</h5> Fundierte Kenntnisse in Windows und Linux,
                was mir ermöglicht, in verschiedenen Umgebungen effektiv zu arbeiten und Probleme zu lösen.
                <br><br><h5>Programmiersprachen:</h5> Grundlegende Kenntnisse in einer Reihe von Programmiersprachen,
